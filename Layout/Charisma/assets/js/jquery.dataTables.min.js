...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Nenhum registro que atenda esta busca",
			 ...
			 *    } );
			 */
			"sInfo": "Mostrando do _START_º ao _END_º de _TOTAL_ registros",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Nenhum registro para mostar",
		...
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).addClass('pagination').append(
				'<ul>'+
					...
					'<li class="next disabled"><a href="#">Seguinte &rarr; </a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
